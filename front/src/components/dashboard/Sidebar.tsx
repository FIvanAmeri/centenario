...
  const sidebarClasses = `fixed top-0 left-0 h-screen w-64 bg-transparent border-r border-white/20 z-50 ${
    modoMovil ? "" : "md:block"
  }`;
...
        <nav className="pt-8 px-4 flex flex-col gap-1">
          <h2 className="text-lg font-bold text-white mb-6 px-2">Menú Principal</h2>
